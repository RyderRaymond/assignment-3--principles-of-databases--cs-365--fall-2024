...
function update($update_attribute, $new_value, $query_attribute, $pattern) {
    try {
        ...
        //Assume we are going to use a value from another table to match off of. This does not include users that do not have an account or websites that have no accounts registered at it.
        ...
        if (("first_name" === $update_attribute || "last_name" === $update_attribute || "user_id" === $update_attribute) && ("first_name" === $query_attribute || "last_name" === $query_attribute || "user_id" === $query_attribute)) {
        ...
        if (("site_name" === $update_attribute || "url" === $update_attribute || "site_id" === $update_attribute) && ("site_name" === $query_attribute || "url" === $query_attribute || "site_id" === $query_attribute)) {
